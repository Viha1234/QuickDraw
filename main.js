...
r = Math.floor(Math.random() * data_set.length);
console.log(r);
img = data_set[r];
document.getElementById("h31").innerHTML = "Sketch to be drawn is :" +img;
}